...
def run_q3_pipeline() -> None:
    settings = load_settings()
    pipeline = settings.q3_pipeline

    if not pipeline.steps:
        raise RuntimeError("No pipeline steps configured for q3 pipeline.")
    ...
    contract_path = settings.project_root / "data/contracts/q3_team_v2.json"
    dataset_path = settings.project_root / "data/processed/q3_team_v2.parquet"
