"""
OPTION A PHASE 3: Train Models on Leakage-Free Pregame Dataset (FIXED)
"""
...
class ModelTrainer:
    ...
    def load_data(self):
        ...
        # FIXED: Only use Four Factors ratios, NOT season average point totals
        # Season averages (home_pts, away_pts, etc.) are not predictive of game totals
        # Only use ratios that capture efficiency
        self.feature_cols = [
    ...
    def save_results(self, results, splits):
        ...
        with open(output_path, 'w') as f:
            f.write("="*70 + "\n")
            f.write("PHASE 3 MODEL TRAINING RESULTS (FIXED - FOUR FACTORS ONLY)\n")
            f.write("="*70 + "\n\n")
    ...
    def run(self):
        ...
        logger.info("="*70)
        logger.info("OPTION A PHASE 3: TRAIN MODELS ON LEAKAGE-FREE DATA (FIXED)")
        logger.info("="*70)
